...
public class IntInputFancyConfigurator implements IFancyConfigurator {
    ...
    public IntInputFancyConfigurator(String key, IGuiTexture icon, Supplier<Integer> valueSupplier, Consumer<Integer> onChanged) {
        this.key = key;
        this.icon = icon;
    ...
    public Widget createConfigurator() {
        return new IntInputWidget(valueSupplier, onChanged)
            .setMax(max)
            .setMin(min);
    }
}
