...
public final class MOPropertyConfiguration {
    ...
    public static final class Builder {
        ...
        public <T extends Enum<T> & StringRepresentable> Builder add(String name, Class<T> valueClass, T defaultValue) {
            return this.add(MOProperty.Creators.create(EnumProperty.create(name, valueClass), defaultValue));
        }
        ...
        public <T extends Enum<T> & StringRepresentable> Builder add(String name, Class<T> valueClass, T defaultValue, Collection<T> allowedValues) {
            return this.add(MOProperty.Creators.create(EnumProperty.create(name, valueClass, allowedValues), defaultValue));
        }
        ...
        public <T extends Comparable<T>> Builder add(Property<T> property, T defaultValue) {
            return add(MOProperty.Creators.create(property, defaultValue, MirrorHandler.Handlers.defaultHandler(), RotationHandler.Handlers.defaultHandler()));
        }

        public <T extends Comparable<T>> Builder add(Property<T> property, T defaultValue, MirrorHandler<T> mirrorHandler) {
            return add(MOProperty.Creators.create(property, defaultValue, mirrorHandler, RotationHandler.Handlers.defaultHandler()));
        }

        public Builder add(DirectionProperty property, Direction defaultValue) {
            return this.add(MOProperty.Creators.create(property, defaultValue, MirrorHandler.Handlers.direction(), RotationHandler.Handlers.direction()));
        }

        public Builder add(EnumProperty<Direction.Axis> property, Direction.Axis defaultValue) {
            return this.add(MOProperty.Creators.create(property, defaultValue, RotationHandler.Handlers.axis()));
        }

        public <T extends Comparable<T>> Builder add(Property<T> property, T defaultValue, RotationHandler<T> rotationHandler) {
            return this.add(MOProperty.Creators.create(property, defaultValue, MirrorHandler.Handlers.defaultHandler(), rotationHandler));
        }
        ...
        public <T extends Comparable<T>> Builder add(Property<T> property, T defaultValue, MirrorHandler<T> mirrorHandler, RotationHandler<T> rotationHandler) {
            return this.add(MOProperty.Creators.create(property, defaultValue, mirrorHandler, rotationHandler));
        }
