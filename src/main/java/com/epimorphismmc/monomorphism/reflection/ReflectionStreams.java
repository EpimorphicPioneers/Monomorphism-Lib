...
public final class ReflectionStreams {
     ...
     * object.
     */
    public static <T extends AccessibleObject & Member> Stream<T> streamMembers(
            @Nonnull Object from) {
        Objects.requireNonNull(from);
     ...
     * object.
     */
    public static <T extends AccessibleObject & Member> Stream<T> streamAccessibleMembers(
            @Nonnull Object from) {
        Objects.requireNonNull(from);
