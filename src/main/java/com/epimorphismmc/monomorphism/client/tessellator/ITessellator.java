...
public interface ITessellator extends Function<Material, TextureAtlasSprite> {
     ...
     * @return this
     */
    ITessellator addScaledVertexWithUV(
            float x, float y, float z, TextureAtlasSprite icon, float u, float v);
     ...
     * @return this
     */
    ITessellator drawScaledFaceDouble(
            float minX, float minY, float maxX, float maxY, Direction face, float offset);
     ...
     * @return this
     */
    ITessellator drawScaledCylinder(
     ...
     * @return this
     */
    ITessellator drawScaledCylinderInside(
            float x, float y, float z, float r, float h, float vMax, int quads);
     ...
     * @return this
     */
    ITessellator drawScaledCylinderOutside(
            float x, float y, float z, float r, float h, float vMax, int quads);
     ...
     * @return this
     */
    ITessellator rotate(Quaternionf quaternion);
