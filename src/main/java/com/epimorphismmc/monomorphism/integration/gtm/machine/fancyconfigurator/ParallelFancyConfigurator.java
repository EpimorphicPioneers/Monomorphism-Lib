...
import static com.epimorphismmc.monomorphism.integration.ldlib.gui.MOGuiTextures.*;
...
public class ParallelFancyConfigurator implements IFancyConfigurator {
    ...
    public Widget createConfigurator() {
        ...
        parallelAmountGroup.addWidget(
                new IntInputWidget(machine::getParallelNumber, machine::setParallelNumber) {
                    @Override
