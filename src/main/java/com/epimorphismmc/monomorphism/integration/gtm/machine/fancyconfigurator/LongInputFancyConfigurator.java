...
public class LongInputFancyConfigurator implements IFancyConfigurator {
    ...
    public LongInputFancyConfigurator(
            String key, IGuiTexture icon, Supplier<Long> valueSupplier, Consumer<Long> onChanged) {
        this.key = key;
        this.icon = icon;
    ...
    public Widget createConfigurator() {
        return new LongInputWidget(valueSupplier, onChanged).setMax(max).setMin(min);
    }
}
